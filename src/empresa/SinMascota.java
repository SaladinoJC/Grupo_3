 ...
 * Extiende la clase Mascota e implementa m�todos espec�ficos para este tipo de viaje.
 */
public class SinMascota extends Mascota {
    ...
    /**
     * Obtiene el incremento de costo por kil�metro para un viaje sin mascotas. (no aumenta)
     * 
    ...
    /**
     * Obtiene el veh�culo asociado al viaje sin mascotas.
     * 
     * @return El veh�culo asociado al viaje sin mascotas.
     */
	@Override
